...
// (e.g. by date or workspace) rather than storing them flat directly under
// session-state, so this walks the whole tree — like Codex's rollout
// discovery — instead of assuming a fixed depth.
